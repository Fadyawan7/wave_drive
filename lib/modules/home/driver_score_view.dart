  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Driver Score', style: AppTextStyles.text10),
        centerTitle: true,
        elevation: 0,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Gap(8),
              Text('100%', style: AppTextStyles.text10),
              const Gap(4),
              Text('Guidance', style: AppTextStyles.text10),
              const Gap(20),
              ...
              Column(
                children: [
                  ...
                  const Gap(12),
                  Text('Compliments', style: AppTextStyles.text10),
                  const Gap(8),
                  Text(
