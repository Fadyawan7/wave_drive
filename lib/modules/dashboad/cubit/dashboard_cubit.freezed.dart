...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardState&&(identical(other.currentIndex, currentIndex) || other.currentIndex == currentIndex));
}
...
class _DashboardState implements DashboardState {
  const _DashboardState({this.currentIndex = 0});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DashboardState&&(identical(other.currentIndex, currentIndex) || other.currentIndex == currentIndex));
}
