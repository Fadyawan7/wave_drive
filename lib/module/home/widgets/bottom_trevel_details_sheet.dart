...
import 'package:wave_drive/module/home/widgets/cancel_reason_bottom_sheet.dart';
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text("Pickup point", style: AppTextStyles.litetext),
                Text(
                ...
                Divider(thickness: 1, color: AppColors.strockcolor),
                const Gap(4),
                Text("Dropoff point", style: AppTextStyles.litetext),
                Text(
