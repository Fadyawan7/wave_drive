    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, scrollController) => Container(
        ...
        child: ListView(
          ...
          children: [
            Text('Driver preference', style: AppTextStyles.bodytext),
            const Gap(8),
            Text('Select reason for cancellation', style: AppTextStyles.litetext),
            const Gap(20),
            _preferenceTile(
              'Vehicle',
            ...
            Row(
              ...
              children: [
                Text('Auto-accept', style: AppTextStyles.bodytext1),
                _toggleSwitch(),
              ],
            ),
          ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Gap(4),
                      Text(subtitle, style: AppTextStyles.litetext),
                    ],
                  ),
                ),
                if (icon != null)
