              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text('$totalRequests', style: AppTextStyles.bodytext1),
                  ],
                ),
                const Divider(),
                Row(
                  ...
                  children: [
                    ...
                    Text('$acceptedRequests', style: AppTextStyles.bodytext1),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    Text('$declinedRequests', style: AppTextStyles.bodytext1),
                  ],
                ),
                Align(
