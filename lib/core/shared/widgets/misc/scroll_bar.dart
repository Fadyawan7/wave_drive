...
const VsScrollbarStyle _kScrollbarStyle = VsScrollbarStyle(
  color: AppColors.primaryD0,
);
const double _kScrollbarThickness = 2.0;
const double _kScrollbarThicknessWithTrack = 12.0;
const double _kScrollbarMargin = 24;
...
class _MaterialScrollbarState extends RawScrollbarState<_MaterialScrollbar> {
  ...
  WidgetStateProperty<Color> get _thumbColor {
    ...
    dragColor = onSurface.withOpacity(1);
    hoverColor = onSurface.withOpacity(1);
    idleColor = onSurface.withOpacity(1);
  ...
  void updateScrollbarPainter() {
    scrollbarPainter
      ...
      ..radius =
          ...
          _scrollbarTheme.radius ??
          (_useAndroidScrollbar ? null : _kScrollbarRadius)
      ..crossAxisMargin = _scrollbarTheme.crossAxisMargin ?? 0.0
      ..mainAxisMargin = _scrollbarTheme.mainAxisMargin ?? 0.0
      ..minLength = _scrollbarTheme.minThumbLength ?? _kScrollbarMinLength
      ..padding = EdgeInsets.symmetric(
        horizontal: 56,
        vertical: _useAndroidScrollbar ? 0.0 : _kScrollbarMargin,
      );
  }
