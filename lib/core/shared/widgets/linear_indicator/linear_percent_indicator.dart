...
class LinearPercentIndicator extends StatefulWidget {
  ...
  LinearPercentIndicator({
    ...
    _progressColor = progressColor ?? AppColors.blue0F;

    _backgroundColor = backgroundColor ?? AppColors.blue96;
...
class _LinearPercentIndicatorState extends State<LinearPercentIndicator>
      ...
      if (mounted) {
        setState(() {
          ...
          if (_keyIndicator.currentContext != null) {
            ...
            indicatorHeight = _keyIndicator.currentContext?.size?.height ?? 0.0;
          }
        });
      }
    });
    if (widget.animation) {
      ...
      _animation =
          Tween(begin: 0.0, end: widget.percent).animate(
            ...
            setState(() {
              _percent = _animation!.value as double;
            });
  ...
  Widget build(BuildContext context) {
    ...
    final percentPositionedHorizontal =
        _containerWidth * _percent - _indicatorWidth / 2;
    final containerWidget = SizedBox(
    ...
    return Material(
      ...
      child: ColoredBox(
        ...
        child: Row(mainAxisAlignment: widget.alignment, children: items),
      ),
    );
  }
