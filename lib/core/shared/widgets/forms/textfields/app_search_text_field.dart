...
class AppSearchTextField extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AppSearchTextFieldState();
}
...
class _AppSearchTextFieldState extends State<AppSearchTextField>
  ...
  @override
  void didUpdateWidget(AppSearchTextField oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoTextField(
      ...
      scrollPadding: widget.scrollPadding ?? const EdgeInsets.all(200.0),
